...
const PaymentHistory = () => {
    ...
    useEffect(() => {
        getStudentData("/payments").then(({ payments }) => setLivePayments(payments.map(payment => ({
            ...
            category: payment.FeeType || "Fee Payment", amount: Number(payment.Amount || 0), method: payment.PaymentMethod || "-", status: payment.Status || "Paid"
        })))).catch(console.error);
    }, []);
            ...
            <section className="payment-info-grid">
                ...
                <div className="payment-info-card">
                    ...
                    <div>
                        ...
                        <p>
                            Payment receipts are available for every paid transaction.
                        </p>
